...
const teamMembers = [
  ...
  {
    name: "Erin Kloke",
    title: "VP, Development & Hospitality",
    initials: "EK",
    color: "bg-gps-gold",
    photo: "/images/erin-kloke.jpg",
    bio: [
      "25+ years of group travel industry experience",
      "Rose to Global Account Director with Hyatt Hotels; managed 22-person team, $100M annual quota",
      "Worked with NFL, NHL, NBA & MLS teams, plus NCAA & youth sports",
      "VP of Sports Accounts with HPN Global — booking tournaments and team travel",
      "Brought OneHockey World tournaments to Omaha; partnered with Minnesota Wild for $4M+ economic impact",
      "Mom of two teens in travel sports for 15 years",
    ],
    quote: null,
  },
  {
    ...
    bio: [
      ...
      "Experience in event management and content production",
      "From Omaha, Nebraska; resides in Overland Park, Kansas",
      "Joined GPS in 2023",
    ],
    quote: null,
  },
